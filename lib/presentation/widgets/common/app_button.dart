...
class AppButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color fallBackColor = color ?? Theme.of(context).colorScheme.primary;
            ...
            children: [
              icon != null
                  ? Icon(
                      icon,
                      color: typoColor,
                      size: iconSize ?? (dimension - (dimension * (55 / 100))),
                    )
                  : const SizedBox(),
              ...
              label != null
                  ? Text(
                      label ?? "",
                      style: TextStyle(color: typoColor).merge(labelStyle),
                    )
                  : const SizedBox()
            ],
          ),
